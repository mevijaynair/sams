...
export const NAV = [
  ...
  { view: 'fixtures',    label: 'Fixtures',      title: 'Fixtures & Results', perm: 'fixtures:read' },
...
const ICONS = {
  ...
  fixtures:    I('<circle cx="12" cy="12" r="9"/><path d="M12 7.5l2.6 1.9-1 3.1h-3.2l-1-3.1L12 7.5z"/><path d="M12 3v2.4M18.4 8.1l-2.3.8M18.4 15.9l-2-1.5M5.6 15.9l2-1.5M5.6 8.1l2.3.8"/>'),
